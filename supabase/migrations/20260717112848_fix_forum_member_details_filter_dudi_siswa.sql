-- Filter DUDI, SISWA, STAKEHOLDER dari fn_get_forum_member_details
-- Ketiganya tidak relevan sebagai penerima posting forum kelas
-- DROP dulu karena return type berubah tidak bisa OR REPLACE
...
BEGIN
    ...
    WHERE u.wali_kelas_class_id = p_class_id
      ...
      AND u.role_type NOT IN ('DUDI'::role_type, 'SISWA'::role_type, 'STAKEHOLDER'::role_type)
