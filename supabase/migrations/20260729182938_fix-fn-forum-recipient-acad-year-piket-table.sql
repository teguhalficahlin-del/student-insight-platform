-- Fix dua bug di fn_get_forum_recipient_candidates:
-- 1. Format v_acad_year: '2026/27' → '2026/2027' (4 digit tahun kedua)
-- 2. Branch GURU_PIKET: teacher_piket_assignments (kosong) → duty_schedules
...
BEGIN
  ...
  -- Fix: ganti teacher_piket_assignments → duty_schedules
