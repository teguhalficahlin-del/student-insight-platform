-- ============================================================
-- Fix: fn_create_forum_post PATH A — validasi penerima server-side
--
-- Masalah: PATH A (scope_type='SEKOLAH') menerima p_specific_user_ids[]
-- dari client tanpa validasi. Ortu bisa mengirim pesan ke UUID sembarang,
-- termasuk user dari sekolah lain (KEAMANAN-1, audit-ortu.md 2026-07-31).
--
-- Fix: filter p_specific_user_ids hanya ke user yang aktif di sekolah caller
-- dan memiliki role staf (bukan siswa/ortu). Seluruh PATH B tidak diubah.
-- ============================================================
