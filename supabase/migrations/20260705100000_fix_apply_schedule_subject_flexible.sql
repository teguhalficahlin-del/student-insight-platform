-- ============================================================
-- FIX: fn_apply_schedule_templates — subject_label fleksibel
--
-- Masalah sebelumnya (20260705090000): hanya cocokkan ke subjects.code.
-- Padahal admin boleh menulis nama panjang ("Matematika") atau
-- singkatan ("MTK") — keduanya harus diterima.
--
-- Logika baru:
--   1. Coba cocokkan subject_label ke subjects.name (ILIKE)
--   2. Coba cocokkan ke subjects.code (ILIKE)
--   3. Jika tidak cocok → get-or-create subject baru dengan label
--      itu sebagai code sekaligus name
--   4. subject_label NULL atau kosong → tetap fallback KBM
-- ============================================================
...
BEGIN
    ...
    -- Sesi harian dengan subject_id yang benar per template
