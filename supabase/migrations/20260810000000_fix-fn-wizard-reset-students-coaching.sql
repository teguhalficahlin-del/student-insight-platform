-- Fix fn_wizard_reset_students: ganti referensi tabel lama cases/case_events
-- ke tabel baru coaching_cases/coaching_case_events.
-- Tabel lama di-DROP oleh 20260802060000_drop-old-cases.sql.
...
BEGIN
    ...
    FROM coaching_cases WHERE student_id = ANY(v_ids) AND school_id = p_school_id;
