-- ============================================================
-- Fix fn_wizard_reset_students: hapus case_events sebelum cases.
-- case_events.case_id → cases.case_id adalah RESTRICT (bukan CASCADE).
-- Fungsi sebelumnya hapus cases dulu sehingga FK violation.
-- ============================================================
...
BEGIN
    ...
    -- case_events dulu (RESTRICT ke cases) — hapus via case_id siswa
