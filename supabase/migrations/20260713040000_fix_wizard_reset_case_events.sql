-- ============================================================
-- Fix fn_wizard_reset_students: nonaktifkan trigger immutable
-- pada case_events sebelum hapus — case_events adalah append-only
-- by design (trg_case_events_immutable), tapi wizard reset adalah
-- operasi superuser yang sah untuk membersihkan data uji.
-- ============================================================
...
BEGIN
    ...
    -- (append-only by design, tapi wizard reset adalah operasi sah)
