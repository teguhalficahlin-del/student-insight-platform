-- Security: tambah role guard ke fn_kepsek_monitoring.
-- Sebelumnya fungsi hanya cek school_id IS NOT NULL, sehingga siapapun
-- yang punya token valid (guru, BK, dll.) bisa panggil RPC ini dan
-- melihat data monitoring kehadiran sekolah yang seharusnya hanya untuk kepsek.
