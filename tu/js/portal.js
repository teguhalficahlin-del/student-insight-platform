...
function buildRecipientGroupButtons() {
    ...
    const groups = [
        ...
        { label: 'Siswa Kelas',   group: 'SISWA_KELAS',      hasIndividual: true,    labelSemua: 'Siswa Semua Kelas'   },
        { label: 'Siswa Jurusan', group: 'SISWA_JURUSAN',    hasIndividual: true,  labelSemua: 'Siswa Semua Jurusan' },
        { label: 'Semua Ortu',    group: 'SEMUA_ORTU',       hasIndividual: false, labelSemua: 'Semua Ortu'  },
        { label: 'Ortu Kelas',    group: 'ORTU_KELAS',       hasIndividual: true,    labelSemua: 'Ortu Semua Kelas'    },
        { label: 'Ortu Jurusan',  group: 'ORTU_JURUSAN',     hasIndividual: true,  labelSemua: 'Ortu Semua Jurusan'  },
